...
export function helpDialog() {
  const keys = [
    ['g then q', 'Queue'], ['g then t', 'Triage'], ['g then l', 'Log'], ['g then v', 'Verdicts'], ['g then r', 'Projects'], ['g then c', 'Courses'], ['g then b', 'Backfill'], ['g then p', 'Pool'], ['g then u', 'Subjects'], ['g then e', 'Evaluate'],
    ['g then s', 'Settings'],
